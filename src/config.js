export const CONFIG = {
    ...
    // Radio chatter
    RADIO_MESSAGES: [
        { distance: 500, text: "MV Eternal Horizon, you are cleared for transit. Godspeed.", speaker: 'COMMAND' },
        { distance: 3000, text: "Scattered mines reported ahead. Stay in the channel.", speaker: 'COMMAND' },
        { distance: 8000, text: "We're gonna get you through. Believe me. Nobody does safe passage better.", speaker: 'TRUMP' },
        { distance: 15000, text: "IRGC patrol boats detected on radar. Maintain course.", speaker: 'COMMAND' },
        { distance: 25000, text: "The ceasefire is holding. For now. Stay vigilant.", speaker: 'BIBI' },
        { distance: 35000, text: "Multiple drone signatures detected. This is getting serious, folks.", speaker: 'TRUMP' },
        { distance: 50000, text: "Ceasefire breach! All stations — defensive posture!", speaker: 'COMMAND' },
        { distance: 65000, text: "We will not allow any vessel to be threatened. Israel stands ready.", speaker: 'BIBI' },
        { distance: 80000, text: "Halfway mark. Nobody thought we'd make it this far. Nobody.", speaker: 'TRUMP' },
        { distance: 95000, text: "I told them — you mess with our ships, there will be consequences. Big consequences.", speaker: 'TRUMP' },
        { distance: 105000, text: "Iron Gauntlet ahead. They're throwing everything at you now.", speaker: 'COMMAND' },
        { distance: 120000, text: "Israel's Iron Dome is covering your corridor. Stay in the channel.", speaker: 'BIBI' },
        { distance: 140000, text: "Final blockade zone. No passage they said — prove them wrong.", speaker: 'COMMAND' },
        { distance: 155000, text: "You can see the other side now. Incredible. The best ship captain, maybe ever.", speaker: 'TRUMP' },
        { distance: 163000, text: "Almost through! The world is watching, Eternal Horizon.", speaker: 'COMMAND' },
        { distance: 166000, text: "One kilometer to open water. Hold steady!", speaker: 'BIBI' },
    ],
