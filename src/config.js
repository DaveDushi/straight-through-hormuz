export const CONFIG = {
  ...
  TERRAIN_COAST_FADE: 22,
  TERRAIN_HEIGHT_SCALE: 12,
  ...
  CEASEFIRE_COLOR: 0xFFDD44,
  PAK_FLAG_DURATION: 10,
  PAK_FLAG_COLOR: 0x00CC44,
  ...
  UPGRADES: {
    rudder: {
      name: "Better Rudder",
      description: "+8% steering speed per level",
      maxLevel: 8,
      baseCost: 400,
      costMult: 2.0,
      effect: 0.08,
    ...
    hull: {
      name: "Hull Plating",
      description: "+12 max hull points per level",
      maxLevel: 8,
      baseCost: 500,
      costMult: 1.9,
      effect: 12,
    ...
    radar: {
      name: "Radar Range",
      description: "+15m Iron Beam & detection range per level",
      maxLevel: 6,
      baseCost: 600,
      costMult: 2.0,
      effect: 15,
    ...
    ironBeam: {
      name: "Iron Beam",
      description: "+8% drone intercept rate per level",
      maxLevel: 6,
      baseCost: 700,
      costMult: 2.0,
      effect: 0.08,
    ...
    fuelTank: {
      name: "Fuel Tank",
      description: "+15 max fuel & +3 regen cap per level",
      maxLevel: 5,
      baseCost: 350,
      costMult: 1.8,
      effect: 15,
    ...
    reinforcedBow: {
      name: "Reinforced Bow",
      description: "-20% wall collision damage per level",
      maxLevel: 4,
      baseCost: 800,
      costMult: 2.0,
      effect: 0.20,
    ...
    oilReserves: {
      name: "Oil Reserves",
      description: "+1s oil boost & +0.08x steering per level",
      maxLevel: 5,
      baseCost: 450,
      costMult: 1.9,
      effect: { duration: 1, mult: 0.08 },
    },
    diplomacy: {
      name: "Diplomatic Channels",
      description: "+1.5s ceasefire duration per level",
      maxLevel: 5,
      baseCost: 500,
      costMult: 1.9,
      effect: 1.5,
    ...
    flagEtiquette: {
      name: "Flag Etiquette",
      description: "+1.5s Pakistani flag duration per level",
      maxLevel: 5,
      baseCost: 550,
      costMult: 1.95,
      effect: 1.5,
    ...
    medicalKit: {
      name: "Medical Kit",
      description: "+5 HP per repair pickup per level",
      maxLevel: 5,
      baseCost: 400,
      costMult: 1.85,
      effect: 5,
    ...
    fuelSiphon: {
      name: "Fuel Siphon",
      description: "+8 fuel per fuel pickup per level",
      maxLevel: 5,
      baseCost: 350,
      costMult: 1.8,
      effect: 8,
    ...
    laserCapacitor: {
      name: "Laser Capacitor",
      description: "+1.5s Iron Beam buff duration per level",
      maxLevel: 5,
      baseCost: 550,
      costMult: 1.9,
      effect: 1.5,
