...
export class Resource extends Entity {
    ...
    _buildMesh() {
        ...
        const coreGeo = getGeometry('resource-core', () =>
            new THREE.BoxGeometry(CONFIG.RESOURCE_SIZE, CONFIG.RESOURCE_SIZE * 0.7, CONFIG.RESOURCE_SIZE)
        );
        // Each resource instance needs its own material to change color
        ...
        const glowGeo = getGeometry('resource-glow', () =>
            new THREE.SphereGeometry(CONFIG.RESOURCE_SIZE * 0.9, 6, 6)
        );
        ...
        // PointLight REMOVED — glow sphere is sufficient
