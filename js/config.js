export const CONFIG = {
    ...
    TANKER_WIDTH: 4,
    TANKER_LENGTH: 10,
    TANKER_COLOR: 0x6a6a7a,
    TANKER_BRIDGE_COLOR: 0x8899bb,
    ...
    TOLL_CARGO_PERCENT_MIN: 8,
    TOLL_CARGO_PERCENT_MAX: 15,
    ...
    // Port Hub upgrades
    UPGRADES: {
        rudder: { name: 'Better Rudder', maxLevel: 5, baseCost: 500, costMult: 1.8, effect: 0.1 },
        hull: { name: 'Hull Plating', maxLevel: 5, baseCost: 600, costMult: 1.8, effect: 15 },
        radar: { name: 'Radar Range', maxLevel: 3, baseCost: 400, costMult: 2.0, effect: 2 },
        tollDiscount: { name: 'Toll Negotiator', maxLevel: 3, baseCost: 300, costMult: 1.5, effect: 0.15 },
        ceasefire: { name: 'Extended Ceasefire', maxLevel: 3, baseCost: 800, costMult: 2.0, effect: 3 },
    },
};
